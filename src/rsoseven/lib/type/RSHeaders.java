...
public enum RSHeaders {
	RS_2007_CONF("Java/1.7.0-internal", "oldschool.runescape.com",
			"text/html, image/gif, image/jpeg, *; q=.2, */*; q=.2",
			"keep-alive"), RS_EOC_CONF("Java/1.7.0-internal",
			"www.runescape.com",
			"text/html, image/gif, image/jpeg, *; q=.2, */*; q=.2",
			"keep-alive"), RS_2007_JAR("pack200-gzip", "Java/1.7.0-internal",
			"oldschool.runescape.com",
			"text/html, image/gif, image/jpeg, *; q=.2, */*; q=.2",
			"keep-alive"), RS_EOC_JAR("pack200-gzip", "Java/1.7.0-internal",
			"www.runescape.com",
			"text/html, image/gif, image/jpeg, *; q=.2, */*; q=.2",
			"keep-alive");
	...
	RSHeaders(String acceptencoding, String userAgent, String host,
